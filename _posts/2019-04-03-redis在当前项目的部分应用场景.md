...
subtitle:   "设备在线状态保持,访客密码功能"
date:       2019-04-03 19:50:00
author:     "Lestat"
bigimg:
...
if obj.Name == "KeepAlive" then
    ...
    -- redis前缀
    local prefix = 'device_heartbeat__'
...
class UserController extends Controller
{
    ...
    //用户访客开门id前缀
    const USER_VISITOR_ID_PREFIX = 'user_visitor_id__';

    //用户访客开门密码前缀
    const USER_VISITOR_PWD_PREFIX = 'user_visitor_pwd__';

    //短信发送次数
    const SMS_TIMES_PREFIX = 'user_sms_times__';
